...
export default function Hero() {
    ...
    return (
        <section className="relative overflow-hidden bg-[#EFF6FF] text-slate-900">
            ...
            <motion.div
                animate={shouldReduceMotion ? { opacity: 0.6 } : { x: [0, 18, 0], y: [0, -12, 0], opacity: [0.5, 0.8, 0.5] }}
            ...
            />
            <motion.div
                animate={shouldReduceMotion ? { opacity: 0.6 } : { x: [0, -18, 0], y: [0, 10, 0], opacity: [0.5, 0.8, 0.5] }}
            ...
            />
            <motion.div
                animate={shouldReduceMotion ? { opacity: 0.6 } : { x: [0, 12, 0], y: [0, -18, 0], opacity: [0.4, 0.7, 0.4] }}
