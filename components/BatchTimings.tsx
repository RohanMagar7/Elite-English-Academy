...
export default function BatchTimings() {
    ...
    return (
        <section className="bg-[#F8FBFF] py-6 sm:py-8" id="batches">
                    ...
                    {batches.map((batch, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group flex flex-col rounded-2xl border border-blue-100 bg-white p-5 shadow-[0_18px_50px_rgba(37,99,235,0.06)] transition-all duration-300"
                            >
                                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-secondary transition-colors group-hover:bg-secondary group-hover:text-white">
                                ...
                                <div className="mt-4 space-y-2 font-sm text-muted">
                                ...
                                {batch.description ? (
                                    <p className="mt-2 font-sm leading-6 text-muted">
                                        {batch.description}
                                    </p>
                                ) : null}
                            </motion.div>
