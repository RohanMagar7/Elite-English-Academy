                ...
                <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 xl:px-14">
                    <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
                        <div>
                            ...
                            <p className="mt-4 text-base font-semibold text-blue-700 sm:text-lg">
                                M.A. English | MH-SET
                            </p>
                        ...
                        <div className="rounded-[2rem] border border-blue-100 bg-[#F8FBFF] p-6 shadow-[0_18px_45px_rgba(37,99,235,0.08)]">
                            ...
                            <div className="mt-6 rounded-2xl border border-blue-200 bg-white p-4 text-sm text-slate-600">
